...
$payload = [
    ...
    "narrative" =>"Production payout",
    "beneficiaryAccount" =>$_POST['phone'],
    "beneficiaryName" =>$_POST['name'],
...
curl_setopt($ch, CURLOPT_URL, 'https://gateway.apps.platform.stanbicbank.co.ug/fp-domestic/v1.0/mobiletransfer');
