...
$payload = [
    "requestId" => "1695985370", //pass the transactionrefNumber
    "clientId" => "EBIMSUAT",
];
...
$token = "AAIgYjhiMzNiZmQ4ZGUwZTk1YjAwZGQ1NzQ0NzJiZTliYmbuGcJGxElCVCEYY2fN-go0C7g8yZS6Sap43bjOD0f6c73-M3gulVpNYL-rB9dwZl6Wdk6xnMFIiCLRwhY2XnSt63VYCDmrBN-HY2BgDiRj8g42bJU23s9LfjurLowZMy4";//jwt


curl_setopt($ch, CURLOPT_URL, 'https://gateway.apps.sandbox.stanbicbank.co.ug/fp/v1.1/merchantpaymentstatus');
