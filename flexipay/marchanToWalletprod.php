...
$payload = [
  "requestId" => "EbP".time(),
  "clientId" => "EBIMSPRD",
  "narrative" => "production Payment",
  "beneficiaryAccount" => "256789497829",
  "beneficiaryName" => "Jacob Janga",
  "mobileNumber" => "256789497829",
  "amount" => "10000",
  "network" => "WALLET",
  "destination" => "WALLET"
];
...
curl_setopt($ch, CURLOPT_URL, 'https://gateway.apps.platform.stanbicbank.co.ug/fp-domestic/v1.0/walletpayment');
