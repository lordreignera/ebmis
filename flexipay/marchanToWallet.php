...
$payload = [
  ...
  "clientId" => "EBIMSUAT",
  "narrative" => "Payment",
  "beneficiaryAccount" => "256784015295",
  "beneficiaryName" => "beneficiaryName",
  "mobileNumber" => "256784015295",
  "amount" => "100000",
  "network" => "WALLET",
  "destination" => "WALLET"
];
...
curl_setopt($ch, CURLOPT_URL, 'https://gateway.apps.sandbox.stanbicbank.co.ug/fp-domestic/v1.0/walletpayment');
