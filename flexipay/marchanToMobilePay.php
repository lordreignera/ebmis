...
$payload = [
    ...
    "beneficiaryAccount" =>"256701234110",
    "beneficiaryName" =>"Akullo Ruth",
    "mobileNumber" =>"256701234110",
];
...
$token = $_POST['token'];//jwt


curl_setopt($ch, CURLOPT_URL, 'https://gateway.apps.sandbox.stanbicbank.co.ug/fp-domestic/v1.0/mobiletransfer');
