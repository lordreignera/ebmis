...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('student_loans', function (Blueprint $table) {
            ...
            // Foreign Keys - Student must be active
            ...
            // Repayment Details
            $table->integer('repay_strategy')->nullable()->comment('1=Parent/Guardian Payment, 2=Student Account');
            $table->string('business_name', 1000)->nullable()->comment('Institution name');
            $table->string('business_contact', 1000)->nullable()->comment('Student/Guardian contact address');
            $table->enum('repay_period', ['daily', 'weekly', 'monthly'])->default('monthly');
            
            // Supporting Documents
            $table->string('business_license', 1000)->nullable()->comment('Student ID/Admission letter');
            $table->string('bank_statement', 1000)->nullable()->comment('Guardian ID/Documents');
            $table->string('business_photos', 1000)->nullable()->comment('Fee statement/Invoice');
            ...
            $table->text('loan_purpose')->nullable()->comment('Purpose of the loan (tuition, accommodation, etc.)');
