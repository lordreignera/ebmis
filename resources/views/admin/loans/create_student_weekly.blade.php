...
@section('title', 'Create Student Weekly Loan Account')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Student Weekly Loan Account</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.school.loans.store') }}" method="POST" enctype="multipart/form-data" id="loanForm">
                        @csrf
                        <input type="hidden" name="loan_type" value="student">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="loan_code" value="STWLOAN{{ time() }}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <small class="text-muted">Only verified and approved students are shown</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="repay_strategy" required>
                                        <option value="">Select...</option>
                                        <option value="1">Parent/Guardian Payment</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label">Student/Guardian Contact Address <span class="text-danger">*</span></label>
...
$(document).ready(function() {
    ...
    // Auto-select branch when student changes
    ...
    // Initialize Select2 for enhanced student selection with search
    $('#member_id').select2({
        placeholder: 'Search for verified student...',
        allowClear: true,
        width: '100%',
