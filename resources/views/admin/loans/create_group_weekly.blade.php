...
@section('title', 'Create Group Weekly Loan Account')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Group Weekly Loan Account</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.loans.store') }}" method="POST" enctype="multipart/form-data" id="loanForm">
                        ...
                        <input type="hidden" name="repay_period" value="weekly">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="loan_code" value="GWLOAN{{ time() }}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label">Period (No. of Weeks) <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="period" id="period" min="1" max="104" required>
                                    <small class="text-muted">Enter number of weeks (1-104)</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4" id="total_amount_div" style="display: none;">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="total_amount" id="total_amount" step="0.01" min="5000">
                            ...
                            <div class="col-md-4" id="principal_div">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="principal" id="principal" step="0.01" min="2000" required>
                                    <small class="text-muted">Amount per member (Min: UGX 2,000)</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label">Weekly Installment Amount</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="loan_purpose">
                                        ...
                                        <option value="agricultural_activities">Agricultural Activities</option>
                                        <option value="small_business">Small Business Development</option>
                                        <option value="trading_activities">Trading Activities</option>
                                        <option value="livestock">Livestock</option>
                                        <option value="group_savings">Group Savings Enhancement</option>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        console.log('Group Weekly Loan Calculation:', {
                            principal: amount,
                            interest: interest + '%',
                            period: period + ' weeks',
