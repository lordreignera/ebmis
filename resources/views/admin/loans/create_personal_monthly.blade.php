...
@section('title', 'Create Personal Monthly Loan Account')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Personal Monthly Loan Account</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="loan_code" value="PMLOAN{{ time() }}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <small class="text-muted">Minimum: UGX 10,000</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    <label class="form-label">Monthly Installment Amount <span class="text-danger">*</span></label>
