...
@section('title', 'Create School Monthly Loan Account')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create School Monthly Loan Account</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="loan_code" value="SMLOAN{{ time() }}" readonly required>
                                </div>
                            </div>
