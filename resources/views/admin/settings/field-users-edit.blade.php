...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Field User</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Field User</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.settings.field-users.update', $fieldUser->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $fieldUser->code }}" readonly>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('branch_id') is-invalid @enderror" name="branch_id" required>
                                        ...
                                        @foreach($branches as $branch)
                                            <option value="{{ $branch->id }}" {{ old('branch_id', $fieldUser->branch_id) == $branch->id ? 'selected' : '' }}>
                                                {{ $branch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" value="{{ old('fname', $fieldUser->fname) }}" required>
                                    @error('fname')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('mname') is-invalid @enderror" name="mname" value="{{ old('mname', $fieldUser->mname) }}">
                                    @error('mname')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname', $fieldUser->lname) }}" required>
                                    @error('lname')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('nin') is-invalid @enderror" name="nin" value="{{ old('nin', $fieldUser->nin) }}" required>
                                    @error('nin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" name="gender" required>
                                        <option value="">Choose...</option>
                                        <option value="m" {{ old('gender', $fieldUser->gender) == 'm' ? 'selected' : '' }}>Male</option>
                                        <option value="f" {{ old('gender', $fieldUser->gender) == 'f' ? 'selected' : '' }}>Female</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob', $fieldUser->dob) }}">
                                    @error('dob')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control @error('mobile_pin') is-invalid @enderror" name="mobile_pin" id="mobile_pin_edit" minlength="4" maxlength="10" placeholder="Leave blank to keep current PIN">
                                        <button class="btn btn-outline-secondary" type="button" onclick="togglePinVisibility('mobile_pin_edit', 'pin_icon_edit')">
                                            <i class="mdi mdi-eye" id="pin_icon_edit"></i>
                                        </button>
                                    </div>
                                    <small class="text-muted">Leave blank to keep current PIN, or enter new 4-10 digit PIN</small>
                                    @error('mobile_pin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact', $fieldUser->contact) }}" required>
                                    </div>
                                    @error('contact')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">+256</span>
                                        <input type="text" class="form-control @error('alt_contact') is-invalid @enderror" name="alt_contact" value="{{ old('alt_contact', $fieldUser->alt_contact) }}">
                                    </div>
                                    @error('alt_contact')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">+256</span>
                                        <input type="text" class="form-control @error('fixed_line') is-invalid @enderror" name="fixed_line" value="{{ old('fixed_line', $fieldUser->fixed_line) }}">
                                    </div>
                                    @error('fixed_line')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $fieldUser->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control @error('pp_file') is-invalid @enderror" name="pp_file" accept="image/*,.pdf">
                                    <small class="text-muted">Leave blank to keep existing. Accepted: JPG, JPEG, PNG, PDF (Max: 2MB)</small>
                                    @error('pp_file')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Identification Document <span class="text-muted">(Optional)</span></label>
                                    <input type="file" class="form-control @error('id_file') is-invalid @enderror" name="id_file" accept="image/*,.pdf">
                                    <small class="text-muted">Leave blank to keep existing. Accepted: JPG, JPEG, PNG, PDF (Max: 2MB)</small>
                                    @error('id_file')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mt-4 d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="mdi mdi-content-save me-1"></i> Update Field User
                            </button>
