                ...
                <table class="table modern-table" id="branchesTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $branch->name }}</td>
                            <td>BRN{{ str_pad($branch->id, 3, '0', STR_PAD_LEFT) }}</td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-sm btn-outline-primary" title="Edit" data-id="{{ $branch->id }}">
                                        <i class="mdi mdi-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-info" title="View" data-id="{{ $branch->id }}">
                                        <i class="mdi mdi-eye"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-danger" title="Delete" data-id="{{ $branch->id }}">
...
<div class="modal fade" id="addBranchModal" tabindex="-1" aria-labelledby="addBranchModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addBranchForm" class="form-validate">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3" required placeholder="Enter branch address/location"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter branch description (optional)"></textarea>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#addBranchForm').on('submit', function(e) {
        ...
        if (this.checkValidity()) {
            ...
            setTimeout(function() {
                ...
                submitBtn.html('Save Branch').prop('disabled', false);
    ...
    $('#branchSearch').on('keyup', function() {
        $('#branchesTable').DataTable().search(this.value).draw();
    });
