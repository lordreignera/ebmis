...
<div class="container-fluid">
    @include('admin.partials.page-header', [
        ...
        'subtitle' => 'Class details and student list.',
        'icon' => 'mdi mdi-google-classroom',
        'backFallback' => route('school.classes.index'),
        'backLabel' => 'Back to Classes',
        'actions' => '<a href="' . route('school.classes.edit', $class) . '" class="btn btn-primary"><i class="mdi mdi-pencil me-1"></i>Edit Class</a>',
    ])
