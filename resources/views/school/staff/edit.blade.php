            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h4 mb-1" style="color: #000000;">
                        <i class="mdi mdi-pencil me-2"></i>Edit Staff: {{ $staff->full_name }}
                    </h2>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('school.staff.update', $staff) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="other_names" 
                                       name="other_names" 
                                       value="{{ old('other_names', $staff->other_names) }}">
                                @error('other_names')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="nationality" 
                                       name="nationality" 
                                       value="{{ old('nationality', $staff->nationality ?? 'Ugandan') }}">
                                @error('nationality')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('staff_type') is-invalid @enderror" 
                                    ...
                                    <option value="Teaching" {{ old('staff_type', $staff->staff_type) == 'Teaching' ? 'selected' : '' }}>Teaching Staff</option>
                                    <option value="Non-Teaching" {{ old('staff_type', $staff->staff_type) == 'Non-Teaching' ? 'selected' : '' }}>Non-Teaching Staff</option>
                                </select>
                                @error('staff_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('subjects_taught', $staff->subjects_taught) }}" 
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('highest_qualification') is-invalid @enderror" 
                                    ...
                                    <option value="PhD" {{ old('highest_qualification', $staff->highest_qualification) == 'PhD' ? 'selected' : '' }}>PhD/Doctorate</option>
                                    <option value="Masters" {{ old('highest_qualification', $staff->highest_qualification) == 'Masters' ? 'selected' : '' }}>Masters Degree</option>
                                    <option value="Bachelors" {{ old('highest_qualification', $staff->highest_qualification) == 'Bachelors' ? 'selected' : '' }}>Bachelors Degree</option>
                                    <option value="Diploma" {{ old('highest_qualification', $staff->highest_qualification) == 'Diploma' ? 'selected' : '' }}>Diploma</option>
                                    <option value="Certificate" {{ old('highest_qualification', $staff->highest_qualification) == 'Certificate' ? 'selected' : '' }}>Certificate</option>
                                    <option value="A-Level" {{ old('highest_qualification', $staff->highest_qualification) == 'A-Level' ? 'selected' : '' }}>A-Level</option>
                                    <option value="O-Level" {{ old('highest_qualification', $staff->highest_qualification) == 'O-Level' ? 'selected' : '' }}>O-Level</option>
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('institution_attended', $staff->institution_attended) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('year_of_graduation', $staff->year_of_graduation) }}" 
                                       min="1950" 
                                       max="{{ date('Y') }}" 
                                       placeholder="{{ date('Y') }}">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('certifications') is-invalid @enderror" 
                                          ...
                                          name="certifications" 
                                          rows="2" 
                                          placeholder="List any additional certifications, courses, or training">{{ old('certifications', $staff->certifications) }}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="allowances" 
                                       name="allowances" 
                                       value="{{ old('allowances', $staff->allowances ?? 0) }}" 
                                       step="0.01" 
                                       min="0" 
                                       placeholder="100000">
                                @error('allowances')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('payment_frequency') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="Monthly" {{ old('payment_frequency', $staff->payment_frequency ?? 'Monthly') == 'Monthly' ? 'selected' : '' }}>Monthly</option>
                                    <option value="Weekly" {{ old('payment_frequency', $staff->payment_frequency) == 'Weekly' ? 'selected' : '' }}>Weekly</option>
                                    <option value="Daily" {{ old('payment_frequency', $staff->payment_frequency) == 'Daily' ? 'selected' : '' }}>Daily</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" 
                                       ...
                                       value="{{ old('mobile_money_number', $staff->mobile_money_number) }}" 
                                       placeholder="0700000000">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h5 class="border-bottom pb-2 mb-3" style="color: #000000;">
                                    <i class="mdi mdi-file-check me-2"></i>Current Documents
                                </h5>
                            </div>
                            @if($staff->cv_path)
                                <div class="col-md-4 mb-3">
                                    <label class="form-label" style="color: #000000;">Current CV</label>
                                    <div>
                                        <a href="{{ Storage::url($staff->cv_path) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                            <i class="mdi mdi-download me-1"></i>Download CV
                                        </a>
                                    </div>
                                </div>
                            @endif
                            @if($staff->certificate_path)
                                <div class="col-md-4 mb-3">
                                    <label class="form-label" style="color: #000000;">Current Certificate</label>
                                    <div>
                            ...
                            @if($staff->id_photo_path)
                                <div class="col-md-4 mb-3">
                                    <label class="form-label" style="color: #000000;">Current Photo</label>
                                    <div>
                                        <img src="{{ Storage::url($staff->id_photo_path) }}" class="rounded" width="100">
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="mdi mdi-content-save me-1"></i>Update Staff Member
                            </button>
